    ...
    <div class="container">
        <div class="content">
            ...
            <form action="../../../app/insertProducts.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="price_product" min="0" max="999" id="profit_margin" onkeyup="updateValue()" required>
                ...
                <input type="text" min="0" step="1" max="500" value="0" name="quantity_product" id="quantity_product">
